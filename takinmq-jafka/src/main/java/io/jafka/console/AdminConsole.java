...
public class AdminConsole {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //
        ArgumentAcceptingOptionSpec<Integer> partitionOpt = parser.acceptsAll(Arrays.asList("P", "partition"), "topic partition")//
        ...
        //
        ArgumentAcceptingOptionSpec<String> passwordOpt = parser.acceptsAll(Arrays.asList("password"), "jafka password")//
