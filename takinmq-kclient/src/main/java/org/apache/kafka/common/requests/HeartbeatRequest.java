...
public class HeartbeatRequest extends AbstractRequest {
    ...
    public static class Builder extends AbstractRequest.Builder<HeartbeatRequest> {
        ...
        public String toString() {
            ...
            bld.append("(type=HeartbeatRequest").append(", groupId=").append(groupId).append(", groupGenerationId=").append(groupGenerationId).append(", memberId=").append(memberId).append(")");
            return bld.toString();
        }
    }
    ...
    private HeartbeatRequest(String groupId, int groupGenerationId, String memberId, short version) {
        super(new Struct(ProtoUtils.requestSchema(ApiKeys.HEARTBEAT.id, version)), version);
