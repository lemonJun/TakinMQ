...
public class DescribeGroupsResponse extends AbstractResponse {
    ...
    public static class GroupMetadata {
        ...
        public GroupMetadata(short errorCode, String state, String protocolType, String protocol, List<GroupMember> members) {
        ...
        public static GroupMetadata forError(Errors error) {
            return new DescribeGroupsResponse.GroupMetadata(error.code(), DescribeGroupsResponse.UNKNOWN_STATE, DescribeGroupsResponse.UNKNOWN_PROTOCOL_TYPE, DescribeGroupsResponse.UNKNOWN_PROTOCOL, Collections.<DescribeGroupsResponse.GroupMember> emptyList());
        }
    }
