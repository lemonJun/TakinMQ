 ...
 */
package com.lemon.takinmq.store.config;
...
public class MessageStoreConfig {
    ...
    //delay-mapdb存储目录
    private String storePathDelayMapdb = System.getProperty("user.home") + File.separator + "store" + File.separator + "delay";
    ...
    //    private int tranStateTableMappedFileSize = 2000000 * TransactionStateService.TSStoreUnitSize;
    public static final int TSStoreUnitSize = 24;

    private int tranStateTableMappedFileSize = 2000000 * TSStoreUnitSize;
    ...
    private int tranRedoLogMapedFileSize = 2000000 * CQ_STORE_UNIT_SIZE;
    // 事务回查至少间隔时间
    ...
    public int getTranRedoLogMappedFileSize() {
        return tranRedoLogMapedFileSize;
    }

    public void setTranRedoLogMappedFileSize(int tranRedoLogMapedFileSize) {
        this.tranRedoLogMapedFileSize = tranRedoLogMapedFileSize;
    }

    public int getTranStateTableMappedFileSize() {
        return tranStateTableMappedFileSize;
    }

    public void setTranStateTableMappedFileSize(int tranStateTableMappedFileSize) {
        this.tranStateTableMappedFileSize = tranStateTableMappedFileSize;
    }
