...
public class ClientResponse {
     ...
     */
    public ClientResponse(RequestHeader requestHeader, RequestCompletionHandler callback, String destination, long createdTimeMs, long receivedTimeMs, boolean disconnected, RuntimeException versionMismatch, AbstractResponse responseBody) {
