...
public class MessageCounter {
    ...
    static {
        ...
        for (MessageCounterEntity messageCounterEntity : listInDb) {
            subCounterMap.put(new Integer(messageCounterEntity.getSubject()), messageCounter.new CounterIncreaser(messageCounterEntity));
        }
    ...
    public static int[] getCount(Integer subjectName) {
        ...
        return new int[] { counter.getIn(), counter.getOut(), counter.getPersist() };
    }
