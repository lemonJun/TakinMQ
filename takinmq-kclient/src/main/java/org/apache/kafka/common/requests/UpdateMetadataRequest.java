...
public class UpdateMetadataRequest extends AbstractRequest {
    public static class Builder extends AbstractRequest.Builder<UpdateMetadataRequest> {
        ...
        public Builder(int controllerId, int controllerEpoch, Map<TopicPartition, PartitionState> partitionStates, Set<Broker> liveBrokers) {
        ...
        public String toString() {
            ...
            bld.append("(type: UpdateMetadataRequest=").append(", controllerId=").append(controllerId).append(", controllerEpoch=").append(controllerEpoch).append(", partitionStates=").append(Utils.mkString(partitionStates)).append(", liveBrokers=").append(Utils.join(liveBrokers, " ,")).append(")");
            return bld.toString();
        }
    }
    ...
    public static UpdateMetadataRequest parse(ByteBuffer buffer, int versionId) {
        return new UpdateMetadataRequest(ProtoUtils.parseRequest(ApiKeys.UPDATE_METADATA_KEY.id, versionId, buffer), (short) versionId);
    }
