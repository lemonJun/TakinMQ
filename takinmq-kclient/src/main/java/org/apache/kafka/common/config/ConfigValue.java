...
public class ConfigValue {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(name, that.name) && Objects.equals(value, that.value) && Objects.equals(recommendedValues, that.recommendedValues) && Objects.equals(errorMessages, that.errorMessages) && Objects.equals(visible, that.visible);
    }
    ...
    public String toString() {
        ...
        sb.append("[").append(name).append(",").append(value).append(",").append(recommendedValues).append(",").append(errorMessages).append(",").append(visible).append("]");
        return sb.toString();
    }
}
