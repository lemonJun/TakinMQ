...
public class JoinGroupResponse extends AbstractResponse {
    ...
    public JoinGroupResponse(int version, short errorCode, int generationId, String groupProtocol, String memberId, String leaderId, Map<String, ByteBuffer> groupMembers) {
