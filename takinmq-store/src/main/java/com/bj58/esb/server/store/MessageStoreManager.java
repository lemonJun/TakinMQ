...
import com.bj58.esb.server.store.Service.Service;
import com.bj58.esb.server.store.exception.IllegalTopicException;
import com.bj58.esb.server.store.exception.MetamorphosisServerStartupException;
import com.bj58.esb.server.store.exception.ServiceStartupException;
import com.bj58.esb.server.store.exception.WrongPartitionException;
import com.bj58.esb.server.store.utils.MetaConfig;
import com.bj58.esb.server.store.utils.ThreadUtils;
import com.bj58.esb.server.store.utils.TopicConfig;
...
public class MessageStoreManager implements Service {
	...
	private static MessageStoreManager messageStoreManager = new MessageStoreManager();

	public static MessageStoreManager getInstance(){
	...
	public void initConfig(final MetaConfig metaConfig, final DeletePolicy deletePolicy) {
