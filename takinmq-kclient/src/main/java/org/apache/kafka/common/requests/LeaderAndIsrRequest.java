...
public class LeaderAndIsrRequest extends AbstractRequest {
    ...
    public static class Builder extends AbstractRequest.Builder<LeaderAndIsrRequest> {
        ...
        public String toString() {
            ...
            bld.append("(type=LeaderAndIsRequest").append(", controllerId=").append(controllerId).append(", controllerEpoch=").append(controllerEpoch).append(", partitionStates=").append(Utils.mkString(partitionStates)).append(", liveLeaders=(").append(Utils.join(liveLeaders, ", ")).append(")").append(")");
            return bld.toString();
        }
    }
    ...
    private LeaderAndIsrRequest(int controllerId, int controllerEpoch, Map<TopicPartition, PartitionState> partitionStates, Set<Node> liveLeaders, short version) {
        super(new Struct(ProtoUtils.requestSchema(ApiKeys.LEADER_AND_ISR.id, version)), version);
    ...
    public static LeaderAndIsrRequest parse(ByteBuffer buffer, int versionId) {
        return new LeaderAndIsrRequest(ProtoUtils.parseRequest(ApiKeys.LEADER_AND_ISR.id, versionId, buffer), (short) versionId);
    }
