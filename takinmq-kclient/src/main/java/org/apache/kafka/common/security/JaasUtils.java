...
public class JaasUtils {
    ...
    private static Configuration defaultJaasConfig(LoginType loginType) {
        ...
        if (configEntries == null) {
            String errorMessage;
            errorMessage = "Could not find a '" + loginContextName + "' entry in the JAAS configuration. System property '" + JaasUtils.JAVA_LOGIN_CONFIG_PARAM + "' is " + (jaasConfigFile == null ? "not set" : jaasConfigFile);
