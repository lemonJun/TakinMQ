...
public class BrokerStats {
    ...
    public void record() {
        ...
        this.msgPutTotalTodayMorning = this.defaultMessageStore.getStoreStatService().getPutMessageTimesTotal();
        this.msgGetTotalTodayMorning = this.defaultMessageStore.getStoreStatService().getGetMessageTransferedMsgCount().get();
    ...
    public long getMsgPutTotalTodayNow() {
        return this.defaultMessageStore.getStoreStatService().getPutMessageTimesTotal();
    }

    public long getMsgGetTotalTodayNow() {
        return this.defaultMessageStore.getStoreStatService().getGetMessageTransferedMsgCount().get();
    }
}
