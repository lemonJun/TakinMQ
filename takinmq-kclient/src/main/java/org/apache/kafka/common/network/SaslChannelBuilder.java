...
public class SaslChannelBuilder implements ChannelBuilder {
    ...
    public KafkaChannel buildChannel(String id, SelectionKey key, int maxReceiveSize) throws KafkaException {
        try {
            ...
            if (mode == Mode.SERVER)
                authenticator = new SaslServerAuthenticator(id, jaasConfig, loginManager.subject(), kerberosShortNamer, socketChannel.socket().getLocalAddress().getHostName(), maxReceiveSize, credentialCache);
            else
