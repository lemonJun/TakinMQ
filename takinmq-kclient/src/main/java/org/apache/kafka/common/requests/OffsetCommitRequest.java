...
public class OffsetCommitRequest extends AbstractRequest {
    ...
    public static final class PartitionData {
        ...
        public String toString() {
            ...
            bld.append("(timestamp=").append(timestamp).append(", offset=").append(offset).append(", metadata=").append(metadata).append(")");
            return bld.toString();
        }
    }
    ...
    public static class Builder extends AbstractRequest.Builder<OffsetCommitRequest> {
        ...
        public OffsetCommitRequest build() {
            ...
            switch (version) {
                ...
                case 1:
                    return new OffsetCommitRequest(groupId, generationId, memberId, offsetData);
                case 2:
        ...
        public String toString() {
            StringBuilder bld = new StringBuilder();
            bld.append("(type=OffsetCommitRequest").append(", groupId=").append(groupId).append(", memberId=").append(memberId).append(", generationId=").append(generationId).append(", retentionTime=").append(retentionTime).append(", offsetData=").append(Utils.mkString(offsetData)).append(")");
            return bld.toString();
        }
    }
