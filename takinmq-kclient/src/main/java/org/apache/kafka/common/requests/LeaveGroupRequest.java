...
public class LeaveGroupRequest extends AbstractRequest {
    ...
    public static class Builder extends AbstractRequest.Builder<LeaveGroupRequest> {
        ...
        public String toString() {
            ...
            bld.append("(type=LeaveGroupRequest").append(", groupId=").append(groupId).append(", memberId=").append(memberId).append(")");
            return bld.toString();
        }
    }
    ...
    private LeaveGroupRequest(String groupId, String memberId, short version) {
        super(new Struct(ProtoUtils.requestSchema(ApiKeys.LEAVE_GROUP.id, version)), version);
    ...
    public AbstractResponse getErrorResponse(Throwable e) {
        ...
        switch (versionId) {
            ...
            default:
                throw new IllegalArgumentException(String.format("Version %d is not valid. Valid versions for %s are 0 to %d", versionId, this.getClass().getSimpleName(), ProtoUtils.latestVersion(ApiKeys.LEAVE_GROUP.id)));
        }
    }
    ...
    public static LeaveGroupRequest parse(ByteBuffer buffer, int versionId) {
        return new LeaveGroupRequest(ProtoUtils.parseRequest(ApiKeys.LEAVE_GROUP.id, versionId, buffer), (short) versionId);
    }
