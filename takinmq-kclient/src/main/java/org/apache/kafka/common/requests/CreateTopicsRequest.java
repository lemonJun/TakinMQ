...
public class CreateTopicsRequest extends AbstractRequest {
    ...
    public static final class TopicDetails {
        ...
        public String toString() {
            ...
            bld.append("(numPartitions=").append(numPartitions).append(", replicationFactor=").append(replicationFactor).append(", replicasAssignments=").append(Utils.mkString(replicasAssignments)).append(", configs=").append(Utils.mkString(configs)).append(")");
            return bld.toString();
        }
    }
    ...
    public static class Builder extends AbstractRequest.Builder<CreateTopicsRequest> {
        ...
        public String toString() {
            StringBuilder bld = new StringBuilder();
            bld.append("(type=CreateTopicsRequest").append(", topics=").append(Utils.mkString(topics)).append(", timeout=").append(timeout).append(", validateOnly=").append(validateOnly).append(")");
            return bld.toString();
        }
    }
