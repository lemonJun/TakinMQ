...
/**
 * $Id: SubscriptionData.java 1835 2013-05-16 02:00:50Z lemon $
 */
package com.lemon.takinmq.common.heartbeat;
...
public class SubscriptionData implements Comparable<SubscriptionData> {
    ...
    public String toString() {
        return "SubscriptionData [classFilterMode=" + classFilterMode + ", topic=" + topic + ", subString=" + subString + ", tagsSet=" + tagsSet + ", codeSet=" + codeSet + ", subVersion=" + subVersion + "]";
    }
