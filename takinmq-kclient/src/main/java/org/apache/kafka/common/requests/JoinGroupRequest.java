...
public class JoinGroupRequest extends AbstractRequest {
    ...
    public static class Builder extends AbstractRequest.Builder<JoinGroupRequest> {
        ...
        public String toString() {
            ...
            bld.append("(type: JoinGroupRequest").append(", groupId=").append(groupId).append(", sessionTimeout=").append(sessionTimeout).append(", rebalanceTimeout=").append(rebalanceTimeout).append(", memberId=").append(memberId).append(", protocolType=").append(protocolType).append(", groupProtocols=").append(Utils.join(groupProtocols, ", ")).append(")");
            return bld.toString();
        }
    }
    ...
    public AbstractResponse getErrorResponse(Throwable e) {
        ...
        switch (versionId) {
            case 0:
            case 1:
                return new JoinGroupResponse(versionId, Errors.forException(e).code(), JoinGroupResponse.UNKNOWN_GENERATION_ID, JoinGroupResponse.UNKNOWN_PROTOCOL, JoinGroupResponse.UNKNOWN_MEMBER_ID, // memberId
