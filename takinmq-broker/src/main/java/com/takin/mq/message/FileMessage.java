...
public class FileMessage {
    ...
    public FileMessage(FileChannel channel, long offset, long limit, boolean mutable, AtomicBoolean needRecover) throws IOException {
        super();
     ...
     */
    public FileMessage(FileChannel channel, boolean mutable) throws IOException {
     ...
     * @throws IOException any file exception
     */
    public FileMessage(File file, boolean mutable) throws IOException {
     ...
     * @throws IOException any file exception
     */
    public FileMessage(FileChannel channel, boolean mutable, AtomicBoolean needRecover) throws IOException {
     ...
     * @throws IOException any file exception
     */
    public FileMessage(File file, boolean mutable, AtomicBoolean needRecover) throws IOException {
     ...
     * 从offset开始  获取一个消息的信息
     * 此处都是写死的 
     * 并且 返回的结果里的location是这个消息体结束时的位置   而不是开始时的位置   这也方便下一信消息的读取
     * @param location
     * @return 
     */
