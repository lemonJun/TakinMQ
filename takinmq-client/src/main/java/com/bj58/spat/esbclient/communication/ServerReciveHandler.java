...
public class ServerReciveHandler {
	...
	private final static ThreadPoolExecutor notifyExec = new ThreadPoolExecutor(1, 
			1, 1500L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<Runnable>(), new NamedThreadFactory("[ESB-Client] NotifyWorker", true), new DiscardOldestAndLogPolicy());
