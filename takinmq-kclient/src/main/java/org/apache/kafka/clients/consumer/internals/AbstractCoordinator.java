...
public abstract class AbstractCoordinator implements Closeable {
    ...
    private RequestFuture<ByteBuffer> onJoinFollower() {
        ...
        SyncGroupRequest.Builder requestBuilder = new SyncGroupRequest.Builder(groupId, generation.generationId, generation.memberId, Collections.<String, ByteBuffer> emptyMap());
