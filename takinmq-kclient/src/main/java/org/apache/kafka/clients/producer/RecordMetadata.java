...
public final class RecordMetadata {
    ...
    private RecordMetadata(TopicPartition topicPartition, long offset, long timestamp, long checksum, int serializedKeySize, int serializedValueSize) {
        super();
        this.offset = offset;
    ...
    public RecordMetadata(TopicPartition topicPartition, long baseOffset, long relativeOffset, long timestamp, long checksum, int serializedKeySize, int serializedValueSize) {
        ...
        this(topicPartition, baseOffset == -1 ? baseOffset : baseOffset + relativeOffset, timestamp, checksum, serializedKeySize, serializedValueSize);
    }
