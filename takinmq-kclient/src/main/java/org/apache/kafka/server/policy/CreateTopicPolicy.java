...
public interface CreateTopicPolicy extends Configurable, AutoCloseable {
    ...
    class RequestMetadata {
        ...
        public String toString() {
            return "RequestMetadata(topic=" + topic + ", numPartitions=" + numPartitions + ", replicationFactor=" + replicationFactor + ", replicasAssignments=" + replicasAssignments + ", configs=" + configs + ")";
        }
    }
