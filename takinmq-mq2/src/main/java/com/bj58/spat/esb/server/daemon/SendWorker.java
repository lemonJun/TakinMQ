...
public class SendWorker {
	...
	private final static ThreadPoolExecutor exe = new ThreadPoolExecutor(COUNT, 
			COUNT, 1500L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<Runnable>(), new ThreadRenameFactory("ESB-Send-Thread"));
